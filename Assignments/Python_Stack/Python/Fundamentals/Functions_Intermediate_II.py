...
x[1][0]=15
#2a Change the last_name of the first student from 'Jordan' to 'Bryant'
students[0]['last_name']='Bryant'
#3a In the sports_directory, change 'Messi' to 'Andres'
sports_directory['soccer'][0]=['Andres']
#4a Change the value 20 in z to 30
z[0]['y']="30"
...
#} printInfo(dojo)
# output: 7 LOCATIONS San Jose Seattle Dallas Chicago Tulsa DC Burbank  8 INSTRUCTORS Michael Amy Eduardo Josh Graham Patrick Minh Devon
