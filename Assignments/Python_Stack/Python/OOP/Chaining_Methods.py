...
jorge.make_deposit(100).make_deposit(100).make_deposit(100).make_withdrawal(100).display_user_balance()

sam.make_deposit(100).make_deposit(100).make_withdrawal(100).make_withdrawal(300).display_user_balance()

marty.make_deposit(100).make_withdrawal(100).make_withdrawal(100).make_withdrawal(100).display_user_balance()